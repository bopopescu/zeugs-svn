...
#
# Created: Fri Oct 12 21:55:49 2007
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_sync.setToolTip(_("Synchronize a user database with the master"))
        ...
        self.pushButton_cp.setToolTip(_("Administrative functions for the master database"))
        ...
        self.pushButton_setup.setText(_("Initialize master database"))
